        ...
        const res = await axios.get(
          ...
          }`,
          {
            headers: {
              ...
              token: "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY0ZDc1ZDA1N2ViNmY2ZmJjYjA4NjVjOSIsImlzQWRtaW4iOnRydWUsImlhdCI6MTY5MjA4NTM2NSwiZXhwIjoxNjkyNTE3MzY1fQ.fZ3XL4LhQcNS_sPdmFy4xBKrRKU5HaNHSL1PIxT_N-A",
            },
          }
        );
        console.log(res);
